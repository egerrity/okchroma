...
console.log(`  ink-53-aa   worst ${dark.s10.toFixed(2)}:1 (${dark.s10at})  [light floor 4.5]`)
console.log(`  ink-42-aa  worst ${dark.s11.toFixed(2)}:1 (${dark.s11at})  [light floor 7.0]`)

...
function toApca(req: Require, lcMap: LcMap): Require {
  ...
  // chalk-20 law is a WCAG-lane guarantee. Its apca twin stays the pre-law declaration —
  ...
  if (req.against === 'chalk-20') return { metric: 'apca', against: 'paper-3', targetLc: 85 }

...
//      highlighter, pencil, and pen bands, landing text ~neutral.
// The borrowed shape did the exact opposite: it rose monotonically through the highlighter/pencil
...
const NEUTRAL_TINT_POINTS: Record<'light' | 'dark', readonly TintPoint[]> = {
  light: [
    ...
    [0.950, 0.895], // paper-3  ─┘
    [0.924, 1.000], // wash-4   ─┐ peak: the mid-chalk band, the neutral's most-branded moment
    [0.892, 1.000], // wash-5   ─┘
    [0.852, 0.842], // wash-6   ─┐
    [0.801, 0.653], // wash-7    │
    [0.738, 0.505], // highlighter-26

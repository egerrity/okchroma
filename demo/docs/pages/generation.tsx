...
└─ emit: brandCss / themeToFigma                       generateNeutralScale, resolveLinkInverseTrio run here`}</Pre>
      ...
      <UL>
        <LI><b>The pole, judged first.</b> <Code>onTextIsWhite</Code> (colorMath.ts) at the seed: the pole with the larger APCA |Lc| on the fill. Under the shipped lane the chosen pole must pass <K v={ONS.ratioFloor!} d={1} />:1; if white is preferred and misses, it flips to black when black passes and reads Lc 45 or better.</LI>
        ...
        <LI><b>The clearance.</b> The fill moves in the chosen pole's direction until that pole reads APCA Lc <K v={CO_LC} d={0} /> (critical <K v={CRITICAL_CLEARANCE_LC} d={0} />), firing at the bar + <K v={APCA_ENFORCE_MARGIN_LC} d={1} /> and solving +<K v={APCA_SOLVE_MARGIN_LC} d={1} /> past it, capped at L <K v={CTA_CLEARANCE_CAPS[0]} d={2} /> and <K v={CTA_CLEARANCE_CAPS[1]} d={2} />; 4.5:1 is never capped (<Code>ctaDualGateL</Code>).</LI>
